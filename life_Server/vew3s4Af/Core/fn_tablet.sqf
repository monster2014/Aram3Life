...
["Messanger","Messanger","\A3L_Client2\tablet_new\icons\messanger.paa","\A3L_Client2\tablet_new\icons\clicked\messanger.paa",[""],"a3l_smsmenu"],
...
switch(playerSide) do
{
	case west: 
	{
	ctrlShow[85456,false];
	ctrlShow[85457,false];
	ctrlShow[85706,false];
	};
...
{
	ctrlShow[85458,false];
	ctrlShow[85459,false];
	ctrlShow[85707,false];
};
